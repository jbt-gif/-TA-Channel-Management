...
**04-02 (RatePlan.otaPrice + ARI push client) planned but not yet applied** — schema decision made live (separate `otaPrice` field, not a computed markup), awaiting audit next session.
