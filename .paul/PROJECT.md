...
**Competitive Context (2026-08-31):** Cocotel (cocotel.com) is the founder's direct inspiration for this project and the named competitor to displace — same agency/aggregator business shape (manages OTA distribution + PMS + revenue management for partner hotels, takes a cut of bookings), operating in the same market (Filipino-owned, 200+ hotels/resorts across PH/Indonesia/Australia, 60+ locations). Publicly disclosed terms: no subscription/setup fee, 8% commission for the first 3 months then 15% ongoing per booking, 30+ OTA connections, bundle includes channel management + PMS + revenue management + digital marketing + social media management. Two differentiation angles identified: (1) Cocotel's commission is explicit/published, while this project's markup-spread model is currently opaque to the hotel unless they check OTA prices themselves — a trust gap worth addressing before pilot-hotel pitches; (2) Cocotel's public materials don't surface a dedicated mobile housekeeping tool, which Phase 6 already ships here.
